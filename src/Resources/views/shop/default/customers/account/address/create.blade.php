            ...
            <form id="customer-address-form" method="post" action="{{ route('customer.address.create') }}" @submit.prevent="onSubmit">
                ...
                <div class="account-table-content">
                    ...
                    <div class="control-group" :class="[errors.has('address2') ? 'has-error' : '']">
                        <label for="address2" class="required">{{ __('House Number') }}</label>
                        <input type="text" class="control" name="address2" value="{{ old('address2') }}" id="address1" v-validate="'required'" data-vv-as="&quot;{{ __('House Number') }}&quot;">
