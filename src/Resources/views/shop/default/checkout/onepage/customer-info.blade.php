<form data-vv-scope="address-form">
    ...
    <div class="form-container" v-if="this.new_billing_address">
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[address2][]') ? 'has-error' : '']">
            <label for="billing_address_0" class="required">
                {{ __('House Number') }}
            </label>

            <input type="text" v-validate="'required'" class="control" id="billing_address_0" name="billing[address2][]" v-model="address.billing.address2" data-vv-as="&quot;{{ __('House Number') }}&quot;"/>

            <span class="control-error" v-if="errors.has('address-form.billing[address2][]')">
                @{{ errors.first('address-form.billing[address2][]') }}
            </span>
        </div>
    ...
    @if ($cart->haveStockableItems())
        ...
        <div class="form-container" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
            ...
            <div class="control-group" :class="[errors.has('address-form.shipping[address2][]') ? 'has-error' : '']">
                <label for="shipping_address_0" class="required">
                    {{ __('House Number') }}
                </label>

                <input type="text" v-validate="'required'" class="control" id="shipping_address_0" name="shipping[address2][]" v-model="address.shipping.address2" data-vv-as="&quot;{{ __('House Number') }}&quot;"/>

                <span class="control-error" v-if="errors.has('address-form.shipping[address2][]')">
                    @{{ errors.first('address-form.shipping[address2][]') }}
                </span>
            </div>
