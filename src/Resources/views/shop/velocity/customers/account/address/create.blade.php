        ...
        <form method="post" action="{{ route('customer.address.create') }}" @submit.prevent="onSubmit">
            ...
            <div class="account-table-content">
                ...
                @php
                    ...
                    $addresses2 = explode(PHP_EOL, (old('address2') ?? ''));
                @endphp

                <div class="control-group" :class="[errors.has('address2') ? 'has-error' : '']">
                    <label for="address2" class="mandatory">{{ __('House Number') }}</label>
                    <input type="text" class="control" name="address2" id="address_0" value="{{ $addresses2[0] ?: '' }}" v-validate="'required'" data-vv-as="&quot;{{ __('House Number') }}&quot;">
