...
@endphp
    ...
    @if (isset($shipping) && $shipping)
        ...
        <div :class="`col-12 form-field ${errors.has('address-form.shipping[address2][]') ? 'has-error' : ''}`" style="margin-bottom: 0;">
            ...
            <input
                ...
                v-model="address.shipping.address2"
                @change="validateForm('address-form')"
                data-vv-as="&quot;{{ __('House Number') }}&quot;" />
    ...
    @elseif (isset($billing) && $billing)
        ...
        <div :class="`col-12 form-field ${errors.has('address-form.billing[address2][]') ? 'has-error' : ''}`" style="margin-bottom: 0;">
            ...
            <input
                ...
                v-model="address.billing.address2"
                @change="validateForm('address-form')"
                data-vv-as="&quot;{{ __('House Number') }}&quot;" />
