    ...
    <div class="content full-page">
        <div class="page-header">
            ...
            <?php
                ...
                if($isSendcloudMethod == 'sendcloud') {
                    $sendcloud = true;
                } else {
                    $sendcloud = false;
                }
            ...
            <div class="page-action">
                @if ($shipment->carrier_title == 'SendCloud' && $sendcloud== true)
                    <a href="{{ route('sendcloud.admin.sales.shipment.label.create', $shipment->id) }}" class="btn btn-lg btn-primary">
                        {{ __('Print Label') }}
                    </a>
                @endif
            </div>
